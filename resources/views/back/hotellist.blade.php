...
<ul class="list-group">
    ...
    <li class="list-group-item">From: {{$hotel->country->title}}<br> Hotel: {{$hotel->title}} <br>Picture of hotel: <img src="{{asset($hotel->picture)}}"><br> Trip length: {{$hotel->trip_length}}<br> Price: {{$hotel->price}} EUR</li>
